...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('courses', function (Blueprint $table) {
            ...
            $table->string('slug', 255); // Slug khóa học
            ...
            $table->string('image', 255)->nullable(); // Ảnh đại diện khóa học
            $table->string('instructor', 255)->nullable(); // Tên người hướng dẫn
            $table->integer('duration')->nullable(); // Thời lượng khóa học (tính bằng phút hoặc giờ)
